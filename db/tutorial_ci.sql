...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 03, 2015 at 01:06 AM
...
(1, 'arif', 'arif@gmail.com', 'arifoye', '123456'),
(2, 'Yenni Kurniawati', 'cikyenn@gmail.com', 'yenncute', '123456');
...
--
ALTER TABLE `berita`
 ADD PRIMARY KEY (`id_berita`), ADD KEY `slug` (`slug`);
